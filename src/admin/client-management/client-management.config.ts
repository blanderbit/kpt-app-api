...
export const CLIENT_PAGINATION_CONFIG: PaginateConfig<User> = {
  ...
  filterableColumns: {
    ...
    initSatisfactionLevel: [FilterOperator.EQ, FilterOperator.GT, FilterOperator.LT, FilterOperator.GTE, FilterOperator.LTE, FilterOperator.NULL, FilterSuffix.NOT],
    initHardnessLevel: [FilterOperator.EQ, FilterOperator.GT, FilterOperator.LT, FilterOperator.GTE, FilterOperator.LTE, FilterOperator.NULL, FilterSuffix.NOT],
